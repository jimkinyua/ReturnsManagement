...
namespace Returns.DTOs.Forms
{
    public class FormsDueByMonthDTO
    {
        ...
        public bool CanContinue => IsSubmitted && SubmissionStatus == Returns.DTOs.Returns.Returns_Submission.SubmissionStatus.Draft && !IsLate;
        public bool CanRequestEdit => IsSubmitted && SubmissionStatus == Returns.DTOs.Returns.Returns_Submission.SubmissionStatus.Draft && IsLate;
