    ...
    public class ReportingYearsController : ControllerBase
    {
        ...
        public async Task<ActionResult<ReportingYearDto>> CreateReportingYear(CreateYearDto createYearDto)
        {
            try
            {
                ...
                var existingYear = await _context.ReportingYears
                    .FirstOrDefaultAsync(y => y.Year == createYearDto.Year);
                ...
                // Get the current user (you may need to adjust this based on your authentication setup)
